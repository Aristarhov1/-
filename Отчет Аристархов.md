...
- Прикреплены скрины к заданию 1
...
```
- Lr в коде влияет на линию, при увеличении Lr линия отрисовывается верх

## Выводы
В данной лабораторной работе я изучил и понял как выполнять анализ данных и отрисовывать на основе графики.
